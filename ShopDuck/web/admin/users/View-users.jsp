...
<c:if test="${empty USERS}">
    <c:redirect url="/UsersManagerServlet?action=List" />
</c:if>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div class="container-box">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="${context}/UsersManagerServlet?action=AddOrEdit" class="btn btn-primary">
                + Thêm người dùng
            </a>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="${context}/UsersManagerServlet?action=AddOrEdit&id=${u.id}" 
                                               class="btn-action btn-edit" title="Sửa">
                                                ✏️
                                            </a>
                                            <a href="${context}/UsersManagerServlet?action=Delete&id=${u.id}" 
