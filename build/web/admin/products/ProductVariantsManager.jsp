...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h2>
                <c:choose>
                    <c:when test="${not empty pv.id and pv.id > 0}">🛠️ Cập nhật biến thể #${pv.id}</c:when>
            ...
            <form action="${context}/admin/ProductVariantsManagerServlet" method="post">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="productId" value="${pv.productId}" required min="1">
                            <div class="form-text">Nhập ID của sản phẩm chính.</div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">ID Kích thước (Size ID)</label>
                            <input type="number" class="form-control" name="sizeId" value="${pv.sizeId}" required min="1">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" step="any" class="form-control bg-readonly" name="price" value="${pv.price}" readonly>
                                <span class="input-group-text">VNĐ</span>
                            </div>
                            <div class="form-text text-warning">
                                ⚠️ Giá sản phẩm được quản lý tại trang Sản phẩm gốc.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-center gap-3 mt-4">
                    ...
                    <button type="submit" class="btn btn-primary btn-custom px-5">
                        <c:choose>
                            <c:when test="${not empty pv.id and pv.id > 0}">Cập nhật</c:when>
