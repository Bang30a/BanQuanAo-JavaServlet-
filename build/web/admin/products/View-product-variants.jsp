            ...
            <nav aria-label="Page navigation" class="mt-4">
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                        <a class="page-link" href="${context}/admin/ProductVariantsManagerServlet?action=List&page=${currentPage - 1}">
                            &laquo; Trước
                        </a>
                    </li>
                    ...
                    <c:forEach begin="1" end="${totalPages}" var="i">
                        <li class="page-item ${currentPage == i ? 'active' : ''}">
                            <a class="page-link" href="${context}/admin/ProductVariantsManagerServlet?action=List&page=${i}">
                                ${i}
                            </a>
                        </li>
                    </c:forEach>
