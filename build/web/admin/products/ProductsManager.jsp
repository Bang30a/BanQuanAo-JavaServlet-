...
<body>
    ...
    <div class="container">
        <div class="form-container" style="max-width: 800px; margin: 50px auto; padding: 40px; background: white; border-radius: 16px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
            <h2 class="text-center fw-bold mb-4" style="color: #0f172a;">
                <c:choose>
            ...
            <form action="${context}/admin/ProductsManagerServlet" method="post">
                <input type="hidden" name="action" value="${action}">

                <div class="row">
                    <div class="col-md-7">
                        <div class="mb-3">
                            <label class="form-label fw-bold text-secondary">ID Sản phẩm</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" rows="5" 
                                      placeholder="Nhập mô tả...">${p.description}</textarea>
                        </div>
                    </div>

                    <div class="col-md-5">
                        <div class="mb-3">
                            <label class="form-label fw-bold text-secondary">Link ảnh (URL)</label>
                            <input type="text" class="form-control" name="image" id="imgInput"
                                   value="${p.image}" placeholder="https://..." oninput="previewImage()">
                        </div>
                        
                        <label class="form-label fw-bold text-secondary">Xem trước ảnh:</label>
                        <div class="img-preview-box">
                            ...
                            <span class="placeholder-text text-muted" style="display: ${not empty p.image ? 'none' : 'block'};">
                                Chưa có ảnh
                            </span>
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-center gap-3 mt-4 pt-3 border-top">
                    <a href="${context}/admin/ProductsManagerServlet?action=List" class="btn btn-outline-secondary px-4 fw-bold">
                        Hủy / Xem danh sách
                    </a>
