...
public final class Dashboard_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("        /* Submenu */\n");
      out.write("        .submenu { background: #0f172a; display: none; /* Màu tối hơn chút */ }\n");
      ...
      out.write("/index.jsp\" target=\"_blank\" class=\"view-site-link\">\n");
      ...
      out.write("        <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${context}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/admin/dashboard/Statistics.jsp\" target=\"mainFrame\" class=\"admin-link active-link\">\n");
      out.write("            📊 Thống kê\n");
      out.write("        </a>\n");
      out.write("\n");
      out.write("        <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${context}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/admin/users/View-users.jsp\" target=\"mainFrame\" class=\"admin-link\">\n");
      ...
      out.write("            <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${context}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/admin/products/View-products.jsp\" target=\"mainFrame\">Sản phẩm</a>\n");
      out.write("            <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${context}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/admin/products/View-product-variants.jsp\" target=\"mainFrame\">Biến thể</a>\n");
      out.write("            <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${context}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/admin/products/View-sizes.jsp\" target=\"mainFrame\">Kích cỡ</a>\n");
      out.write("        </div>\n");
      out.write("\n");
      out.write("        <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${context}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/admin/order/View-orders.jsp\" target=\"mainFrame\" class=\"admin-link\">\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${context}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/admin/dashboard/Statistics.jsp\"></iframe>\n");
      out.write("    </div>\n");
      out.write("\n");
      out.write("    <script>\n");
      out.write("    function toggleSubmenu(e) {\n");
      out.write("        e.preventDefault();\n");
      out.write("        const link = e.target; // Thẻ a click vào\n");
      out.write("        link.classList.toggle('active'); // Đổi icon mũi tên\n");
      out.write("        \n");
      out.write("        const submenu = document.getElementById('productSubmenu');\n");
      out.write("        // Hiệu ứng đóng mở\n");
      ...
      out.write("    }\n");
      out.write("\n");
      out.write("    // Script Highlight menu đang chọn\n");
      out.write("    const sidebarLinks = document.querySelectorAll('.sidebar a.admin-link, .submenu a');\n");
      out.write("    \n");
      out.write("    sidebarLinks.forEach(link => {\n");
      out.write("        link.addEventListener('click', function() {\n");
      out.write("            // 1. Bỏ active cũ\n");
      out.write("            sidebarLinks.forEach(l => l.classList.remove('active-link'));\n");
      out.write("            document.querySelectorAll('.view-site-link, .logout a').forEach(l => l.classList.remove('active-link'));\n");
      out.write("            \n");
      out.write("            // 2. Thêm active mới cho link vừa click\n");
      out.write("            this.classList.add('active-link');\n");
      out.write("\n");
      out.write("            // 3. Nếu click vào link con, giữ active cho menu cha\n");
      out.write("            if (this.parentElement.classList.contains('submenu')) {\n");
      out.write("                 // Logic giữ sáng menu cha nếu cần (tuỳ chọn)\n");
      out.write("            }\n");
      out.write("        });\n");
      out.write("    });\n");
      out.write("    </script>\n");
