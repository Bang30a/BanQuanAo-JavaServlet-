...
<head>
    ...
    <style>
        ...
        .pagination .page-link { color: #334155; border-radius: 6px; margin: 0 3px; border: none; background: #f8fafc; }
        .pagination .page-item.active .page-link { background-color: #3b82f6; color: white; font-weight: 600; }
        .pagination .page-link:hover { background-color: #e2e8f0; }
    </style>
</head>
<body>
            ...
            <nav aria-label="Page navigation" class="mt-4">
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                        <a class="page-link" href="${context}/admin/ProductsManagerServlet?action=List&page=${currentPage - 1}&keyword=${param.keyword}">
                            &laquo; Trước
                        </a>
                    </li>
                    ...
                    <c:forEach begin="1" end="${totalPages}" var="i">
                        <li class="page-item ${currentPage == i ? 'active' : ''}">
                            <a class="page-link" href="${context}/admin/ProductsManagerServlet?action=List&page=${i}&keyword=${param.keyword}">
                                ${i}
                            </a>
                        </li>
                    </c:forEach>
