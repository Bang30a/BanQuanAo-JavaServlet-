...
<c:if test="${empty sessionScope.user}">
    <%-- [SỬA PATH] Redirect đúng về trang login --%>
        ...
        <div class="container" style="max-width: 1000px;">
            <div class="cart-card">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <!-- [SỬA LỖI] Trỏ về Servlet /user/view-products thay vì file JSP -->
                    ...
                    <c:if test="${not empty sessionScope.cart && sessionScope.cart.size() > 0}">
                        <!-- [SỬA LỖI] Trỏ về Servlet Checkout -->
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <div class="empty-state">
                            ...
                            <!-- [SỬA LỖI QUAN TRỌNG] Trỏ về Servlet /user/view-products -->
